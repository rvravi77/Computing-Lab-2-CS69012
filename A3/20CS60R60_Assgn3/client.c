...
int main(int argc, char **argv){    	
    ...
    while(1){  
        ...
        printf("Enter Message To Server (RETR;STOR;LIST;QUIT;DELE):\n");     //Prompt to get input from user       
        ...
        int cmd=get_command(command);               //Storing integer code corresponding to command  
        ...
        switch(cmd){
            ...
            case 1:                                                          //for RETR 
                ...
                f = malloc(size);                                            //memory allcocated of size got from server
            ...
            case 2:                                                          //for STOR     
	            ...
	            if( sendfile(sock, filehandle, NULL, size) < 0){              //send the file data to server
                    perror("SEND: ");
                    break;
                }
            ...
            case 7:                                                          //if invalid input from user
                printf("Enter Valid Request \n\n");
            break;
